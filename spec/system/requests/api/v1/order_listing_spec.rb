...
describe 'Orders API' do
  context 'GET /api/v1/orders' do
    it 'fails when informing the code of a restaurant that does not exist' do
      user = User.create!(
        name: 'Aloisio',
    ...
    it 'fails when the app goes through some unknown error' do
      user = User.create!(
        name: 'Aloisio',
        family_name: 'Silveira',
        registration_number: '08000661110',
    ...
    it 'succeeds and returns an empty array when the restaurant does not have orders yet' do
      user = User.create!(
        name: 'Aloisio',
        family_name: 'Silveira',
        registration_number: '08000661110',
    ...
    it 'succeeds when the code of a restaurant that exists and has orders is informed, without filters - separing orders by status' do
      user = User.create!(
        name: 'Aloisio',
        family_name: 'Silveira',
        registration_number: '08000661110',
    ...
    it 'succeeds when the code of a restaurant that exists and has orders is informed, with a "waiting_kitchen_approval" filter' do
      user = User.create!(
        name: 'Aloisio',
        family_name: 'Silveira',
        registration_number: '08000661110',
    ...
    it 'succeeds when the code of a restaurant that exists and has orders is informed, with a "preparing" filter' do
      user = User.create!(
        name: 'Aloisio',
        family_name: 'Silveira',
        registration_number: '08000661110',
    ...
    it 'succeeds when the code of a restaurant that exists and has orders is informed, with a "canceled" filter' do
      user = User.create!(
        name: 'Aloisio',
        family_name: 'Silveira',
        registration_number: '08000661110',
    ...
    it 'succeeds when the code of a restaurant that exists and has orders is informed, with a "ready" filter' do
      user = User.create!(
        name: 'Aloisio',
        family_name: 'Silveira',
        registration_number: '08000661110',
    ...
    it 'succeeds when the code of a restaurant that exists and has orders is informed, with a "delivered" filter' do
      user = User.create!(
        name: 'Aloisio',
        family_name: 'Silveira',
        registration_number: '08000661110',
    ...
    it 'succeeds when the code of a restaurant that exists and has orders is informed, returning an empty array when queried with a valid filter that has no orders' do
      user = User.create!(
        name: 'Aloisio',
        family_name: 'Silveira',
        registration_number: '08000661110',
    ...
    it 'succeeds when the code of a restaurant that exists and has orders is informed, with a status filter that is empty' do
      user = User.create!(
        name: 'Aloisio',
        family_name: 'Silveira',
        registration_number: '08000661110',
    ...
    it 'succeeds when the code of a restaurant that exists and has orders is informed, with a status filter that is invalid' do
      user = User.create!(
        name: 'Aloisio',
        family_name: 'Silveira',
        registration_number: '08000661110',
