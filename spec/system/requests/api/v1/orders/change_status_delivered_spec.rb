...
describe 'Orders API' do
  context 'POST /api/v1/order/deliver' do
    context 'fails when' do
      it 'informing the code of a restaurant that does not exist' do
        ...
        post '/api/v1/order/deliver', params: { restaurant_code: 'XDB13200', order_code: 'AS8LOP42' }
      ...
      it 'informing the code of an order that does not exist' do
        ...
        post '/api/v1/order/deliver', params: { restaurant_code: restaurant.code, order_code: 'AS8LOP42' }
      ...
      it 'informing the code of an order that does not belong to the informed restaurant' do
        ...
        post '/api/v1/order/deliver', params: { restaurant_code: restaurant.code, order_code: second_user_order.code }
    ...
    context 'succeeds' do
      it 'and changes the status of an order to "delivered"' do
        user = User.create!(
          name: 'Aloisio',
          family_name: 'Silveira',
          registration_number: '08000661110',
        ...
        post '/api/v1/order/deliver', params: { restaurant_code: restaurant.code, order_code: order.code }
