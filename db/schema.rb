...
ActiveRecord::Schema[7.2].define(version: 2024_11_22_010844) do
  ...
  create_table "discounted_servings", force: :cascade do |t|
    t.integer "serving_id", null: false
    t.integer "discount_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["discount_id"], name: "index_discounted_servings_on_discount_id"
    t.index ["serving_id"], name: "index_discounted_servings_on_serving_id"
  end
  ...
  add_foreign_key "discounted_servings", "discounts"
  add_foreign_key "discounted_servings", "servings"
